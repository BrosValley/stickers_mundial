...
export default async function ExchangesPage() {
  ...
  const statusColor: Record<ExchangeStatus, string> = {
    pending:   'text-amber-700 bg-amber-100 border-amber-300 dark:text-amber-400 dark:bg-amber-900/20 dark:border-amber-500/30',
    accepted:  'text-green-700 bg-green-100 border-green-300 dark:text-green-400 dark:bg-green-900/20 dark:border-green-500/30',
    rejected:  'text-red-700 bg-red-100 border-red-300 dark:text-red-400 dark:bg-red-900/20 dark:border-red-500/30',
    cancelled: 'text-slate-600 bg-slate-100 border-slate-300 dark:text-slate-400 dark:bg-slate-900/20 dark:border-slate-500/30',
  }
