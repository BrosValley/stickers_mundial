...
export function NotificationBell() {
  ...
  return (
    <Link
      href="/exchanges"
      aria-label={`${count} intercambio${count !== 1 ? 's' : ''} pendiente${count !== 1 ? 's' : ''}`}
      className="relative flex size-10 items-center justify-center rounded-xl border border-amber-500/40 bg-amber-900/20 text-amber-300 transition hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--focus)"
    >
